...
def test_agent_invalid_configuration(
    ...
    bluechi_test.add_bluechi_agent_machine_configs(node_with_long_loglevel_cfg)
    bluechi_test.add_bluechi_agent_machine_configs(node_with_invalid_value_cfg)
    bluechi_test.add_bluechi_agent_machine_configs(node_with_numbersonly_in_loglevel_cfg)
