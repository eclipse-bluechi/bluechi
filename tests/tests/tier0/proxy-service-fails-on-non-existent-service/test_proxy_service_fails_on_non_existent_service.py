...
from hirte_test.util import assemble_hirte_proxy_service_name
...
def verify_proxy_start_failed(foo: HirteNodeContainer):
    ...
    assert foo.wait_for_unit_state_to_be(hirte_proxy_service, "failed")
