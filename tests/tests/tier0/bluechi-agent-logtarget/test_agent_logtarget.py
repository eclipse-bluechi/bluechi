...
def start_with_invalid_logtarget(
    ...
    assert node_with_numbers_only_in_logtarget.wait_for_unit_state_to_be(
...
def test_agent_invalid_logtarget_configuration(
    ...
    node_with_numbersonly_in_logtarget_cfg.node_name = (
    ...
    bluechi_test.add_bluechi_agent_config(node_with_numbersonly_in_logtarget_cfg)
