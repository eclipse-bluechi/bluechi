...
lint-c: build
	...
	eval $(ALL_SRC_FILES) | xargs -0 -I {} clang-tidy --quiet {} -- -I src -I builddir -include config.h -D_GNU_SOURCE
...
lint-fix:
	eval $(ALL_SRC_FILES) | xargs -0 -I {} clang-tidy --quiet {} --fix -- -I src -I builddir -include config.h -D_GNU_SOURCE
